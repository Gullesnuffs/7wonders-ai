...
MANIFACTURED_RESOURCES = [Resource.GLASS, Resource.CLOTH, Resource.PAPYRUS]
NONMANIFACTURED_RESOURCES = [Resource.CLAY, Resource.STONE, Resource.WOOD, Resource.ORE]
...
EAST_TRADING_POST = Card(
        ...
        color=Color.YELLOW,
        effects=[
            TradingEffect(resources=NONMANIFACTURED_RESOURCES, rightNeighbor=True),
            ])
...
WEST_TRADING_POST = Card(
        ...
        color=Color.YELLOW,
        effects=[
            TradingEffect(resources=NONMANIFACTURED_RESOURCES, leftNeighbor=True),
            ])
...
MARKETPLACE = Card(
        ...
        color=Color.YELLOW,
        effects=[
            TradingEffect(resources=MANIFACTURED_RESOURCES, leftNeighbor=True, rightNeighbor=True),
            ])
...
FORUM = Card(
        ...
        effects=[
            ProductionEffect(MANIFACTURED_RESOURCES),
            ])
...
CARAVANSERY = Card(
        ...
        effects=[
            ProductionEffect(NONMANIFACTURED_RESOURCES),
            ])
